    ...
    for selected_config in list(main.cameras_config):
        ...
        if stream_url:
            ...
            if cam_rec_config.get('continuous'):
                main.recording_service.start_continuous_chunk_recording(stream_url=stream_url, camera_id=camera_id, recording_config=cam_rec_config, on_chunk_complete=_make_continuous_chunk_callback(camera_id))
